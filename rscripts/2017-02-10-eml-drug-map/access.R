...
############################################################
# Load geojson
geo_data <- geojson_read('./_data/2017-02-10-eml-drug-map/admin0_countries_50m.geojson',
                         what = 'sp')
# Other countries
...
#                                                          #
############################################################
save(list = c('geo_data', 'geo_other', 'popup_first', 'popup_second',
              'popup_third', 'pal_first', 'pal_second', 'pal_third',
              'pal_income', 'popup_NA'),
     file = './_data/2017-02-10-eml-drug-map/access_plot.RData')
